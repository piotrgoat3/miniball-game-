(function () {
    ...
    const stadiumsData = [
        {
            name: "Anfield",
            // === UŻYJ NAZWY PLIKU, KTÓRY MASZ W REPO ===
            image: "46e2051f-681e-49d9-b519-7f2d7d297d72.png" // Używamy tej nazwy w populateStadiumSelection
        }
     ...
     document.addEventListener("DOMContentLoaded", () => {
         ...
         if (startMatchFromStadiumBtn) startMatchFromStadiumBtn.addEventListener("click", () => {
             ...
             if (selectedStadium === "Anfield") {
                 // === ZMIANA: Używamy poprawnej nazwy pliku ===
         ...
         console.log("MiniSoccer v15 - Poprawiono nazwę pliku tła Anfield");
     });
